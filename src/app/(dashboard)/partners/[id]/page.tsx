    ...
    <>
      ...
      <div className="relative mb-5 overflow-hidden rounded-card-lg ring-1 ring-divider">
        ...
        <div className="absolute left-5 top-5">
          <span className="inline-flex items-center gap-1.5 rounded-full bg-surface/95 px-3 py-1.5 text-xs font-bold text-fg ring-1 ring-divider backdrop-blur-sm">
      ...
      <div className="mb-5 flex flex-wrap items-center justify-between gap-4">
        ...
        <span className="rounded-full bg-success-bg/60 px-3 py-1 text-xs font-bold text-success-fg">
