...
export default function DashboardHomePage() {
  const newApplications = incomingApplications
    ...
    <>
      ...
      <div className="grid gap-6 xl:grid-cols-3">
        ...
        <SectionCard
          ...
          description="Incoming students waiting for first review."
          action={{ label: "Open inbox", href: "/incoming" }}
          className="xl:col-span-2"
        >
