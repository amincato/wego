    ...
    <div className="relative h-[calc(100dvh-13rem)] min-h-[600px] overflow-hidden rounded-card-lg">
      ...
      >
            ...
            >
              <Popup>
                <div className="min-w-[280px]">
                  <div className="mb-1.5 text-[11px] font-bold uppercase tracking-wider text-school">
                    Partner school
                  </div>
        ...
        >
          <Popup>
            <div className="min-w-[280px]">
              <div className="mb-1.5 text-[11px] font-bold uppercase tracking-wider text-student">
                My school
              </div>
              <div className="text-lg font-bold leading-tight text-fg">
