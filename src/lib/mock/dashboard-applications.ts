...
export const incomingApplications: ApplicationExtended[] = [
  {
    ...
    letterOfMotivation:
      "Dear coordinator, my name is Matthis and I would love to spend my exchange year at Friedrich Schiller Gymnasium because German is the language I'm most passionate about, and I really want to bring it to a fluent level. Learning German in a real classroom — with native speakers, real homework and a host family at home — would make a huge difference compared to studying it from a textbook in Lyon. I'm planning to apply to university in Germany after high school, so this year would also help me get comfortable with the system, the academic culture and daily life there. Outside of class I'm a pretty active person: I play football, I love photography and I'm always up for trying new sports or visiting a new city on the weekend, so I'd be happy to take part in any extracurricular activity the school runs. Thanks for considering my application — I really hope to be part of your community next year. Best regards, Matthis",
